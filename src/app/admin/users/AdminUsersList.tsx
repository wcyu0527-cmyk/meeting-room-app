...
export default function AdminUsersList({ profiles, units }: { profiles: Profile[], units: Unit[] }) {
    ...
    return (
        <div>
            <div className="bg-card px-4 py-5 border-b border-border sm:px-6 flex justify-between items-center">
            ...
            {showCreateForm && (
                <div className="bg-muted/30 px-4 py-5 sm:px-6 border-b border-border">
                    <form onSubmit={handleCreate} className="space-y-4 max-w-lg">
                        <div>
                            <label className="block text-sm font-medium text-foreground">帳號 (Username)</label>
                            <input
                                type="text"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-medium text-foreground">密碼</label>
                            <input
                                type="password"
                                required
                        ...
                        <button
                            type="submit"
                            disabled={isCreating}
                            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring disabled:opacity-50"
                        >
